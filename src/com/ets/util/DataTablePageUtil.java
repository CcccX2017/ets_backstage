...
public class DataTablePageUtil<T> {  
     ...
     * 当前页码 
     */  
    private int page_num = Const.Role.PAGE_NUM;  
      
    /* 
     * 每页数据 
     */  
    private int page_size = Const.Role.PAGE_SIZE;  
